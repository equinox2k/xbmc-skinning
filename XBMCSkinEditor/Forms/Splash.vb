...
Public Class Splash
    ...
    Private Sub Splash_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim objBitmap As Bitmap = New Bitmap(My.Resources.Splash)
        Version.Text = System.String.Format("{0}.{1}.{2}", My.Application.Info.Version.Major, My.Application.Info.Version.Minor, My.Application.Info.Version.Build)
        SetBitmap(objBitmap)
    End Sub
